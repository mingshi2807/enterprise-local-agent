...
export const SessionSidebar = memo(function SessionSidebar({ expanded, conversations, loading, error, selectedSessionId, onSelectSession, onNewTask }: Props) {
  if (!expanded) {
    return (
